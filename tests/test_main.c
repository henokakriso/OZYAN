...
extern int run_attempt_control_tests(void);
extern int run_session_management_tests(void);
extern int run_authorization_tests(void);
...
extern int run_deletion_tests(void);
extern int run_incident_tests(void);
...
extern int run_cr_io_stream_tests(void);
extern int run_cr_io_router_tests(void);
...
extern int run_cr_workflow_checkpoint_tests(void);
extern int run_cr_startup_recovery_tests(void);
...
extern int run_cr_execution_result_tests(void);
...
int main(void) {
    ...
    suite_fail = run_attempt_control_tests();              suite_pass = 55 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    suite_fail = run_session_management_tests();           suite_pass = 110 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    suite_fail = run_authorization_tests();                suite_pass = 84 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    ...
    suite_fail = run_backup_tests();                       suite_pass = 82 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    suite_fail = run_deletion_tests();                     suite_pass = 81 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    suite_fail = run_incident_tests();                     suite_pass = 127 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    ...
    suite_fail = run_cr_io_stream_tests();                  suite_pass = 100 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    suite_fail = run_cr_io_router_tests();                  suite_pass = 100 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
    ...
    suite_fail = run_cr_workflow_checkpoint_tests();      suite_pass = 100 - suite_fail; total_pass += suite_pass; total_fail += suite_fail;
