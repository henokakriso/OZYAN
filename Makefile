...
SEC_OBJ = $(BUILD)/03_SECURITY/data_classification.o $(BUILD)/03_SECURITY/secure_data.o $(BUILD)/03_SECURITY/secure_data_object.o $(BUILD)/03_SECURITY/storage_provider.o $(BUILD)/03_SECURITY/storage_provider_mem.o $(BUILD)/03_SECURITY/storage_provider_local.o $(BUILD)/03_SECURITY/protection_provider.o $(BUILD)/03_SECURITY/protection_provider_mock.o $(BUILD)/03_SECURITY/key_provider.o $(BUILD)/03_SECURITY/key_provider_test.o $(BUILD)/03_SECURITY/protection_provider_sodium.o $(BUILD)/03_SECURITY/secure_key_storage.o $(BUILD)/03_SECURITY/secure_key_storage_test.o $(BUILD)/03_SECURITY/key_lifecycle.o $(BUILD)/03_SECURITY/secure_vault.o $(BUILD)/03_SECURITY/identity.o
OBJS    += $(SEC_OBJ)
