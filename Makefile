...
SEC_SRC = 03_SECURITY/data_classification.c 03_SECURITY/secure_data.c 03_SECURITY/secure_data_object.c 03_SECURITY/storage_provider.c 03_SECURITY/storage_provider_mem.c
SEC_OBJ = $(BUILD)/03_SECURITY/data_classification.o $(BUILD)/03_SECURITY/secure_data.o $(BUILD)/03_SECURITY/secure_data_object.o $(BUILD)/03_SECURITY/storage_provider.o $(BUILD)/03_SECURITY/storage_provider_mem.o
OBJS    += $(SEC_OBJ)
